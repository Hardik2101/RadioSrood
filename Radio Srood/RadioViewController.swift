...
protocol RadioViewControllerDelegate: NSObjectProtocol{
    func radioPlayerViewPlayPause(playerViewController: RadioViewController!)
}
...
class RadioViewController: UIViewController, GADInterstitialDelegate {
    ...
    override func viewDidLoad() {
        ...
        NotificationCenter.default.addObserver(self,
                                               selector: #selector(RadioViewController.loadRadioData),
                                               name:NSNotification.Name(rawValue: "ReloadRadio"),
                                               object: nil)
        
        NotificationCenter.default.addObserver(self,
                                               selector: #selector(RadioViewController.stopPlayer),
                                               name:NSNotification.Name(rawValue: "PauseRadio"),
                                               object: nil)
